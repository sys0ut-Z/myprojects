  ...
  return (
    <div>
      <div className='relative min-h-[500px] min-w-screen'>
        ...
        {/* Links Section */}
        <div className='bg-black/65 relative top-0 left-0 min-h-[500px] min-w-screen z-10'>
          <div className='container py-28'>
            <div className='py-10 px-3 bg-white rounded-md grid grid-cols-2 md:grid-cols-4 gap-8'>
              ...
              <div className='space-y-3'>
                <div className='grid grid-cols-2 max-lg:grid-cols-1 justify-items-center pt-6'>
                  ...
                  <p className='text-sm max-sm:line-clamp-3'>
                ...
                <div className='flex gap-3 items-center px-2'>
                  <span><FaLocationArrow size={17}/></span>
                  <span className='tracking-wide'>Gujarat, Ahmedabad</span>
                </div>
                <div className='flex gap-2 items-center px-2'>
                  <span><IoPhonePortraitSharp size={17}/></span>
                  <span className='tracking-wide'>+91 1254376980</span>
                </div>
              ...
              {/* Links Section 1 */}
              <div>
                <h1 className='text-2xl lg:text-3xl font-bold'>Car Companies</h1>
                <ul className='pt-4 space-y-4'>
                  {
                    ["Koenigsegg", "Bugatti", "Ferrari", "Lamborghini", "Astom Martin"].map((text, id) => (
                      <li className='text-lg' key={id}>
                        <a href={`/#${text}`} className='hover:text-primary transition-all duration-300'>{text}</a>
                      </li>
                    ))
                  }
                </ul>
              ...
              {/* Links Section 3 */}
              <div>
                <h1 className='text-2xl lg:text-3xl font-bold'>Other Links</h1>
                <ul className='pt-4 space-y-4'>
                  {
